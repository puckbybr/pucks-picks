    ...
    steps:
      ...
      - name: Commit and push updated dashboard
        run: |
          ...
          git add pucks-picks-dashboard.html
...
with open('/mnt/user-data/outputs/pucks-picks-dashboard.html', 'w', encoding='utf-8') as f:
    f.write(page)
print(f"Dashboard done! {len(page):,} bytes")
